...
<main style="display:flex;flex-direction:column;align-items:center;min-height:80vh;">
    <div class="card" style="margin-top:2.5rem;padding:2.5rem 2.5rem 2rem 2.5rem;min-width:400px;max-width:900px;width:100%;box-shadow:0 4px 24px rgba(229,57,53,0.08);">
        ...
        <div class="admin-dashboard-btn-row">
            <a href="admin_buses.php" class="admin-dashboard-btn"><i class="fa fa-bus"></i> Manage Buses</a>
            <a href="admin_routes.php" class="admin-dashboard-btn"><i class="fa fa-road"></i> Manage Routes</a>
            <a href="admin_schedules.php" class="admin-dashboard-btn"><i class="fa fa-calendar-alt"></i> Manage Schedules</a>
