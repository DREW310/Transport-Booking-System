                    ...
                    <tr>
                        ...
                        <td>
                            <div class="bus-action-group">
                                <a href="admin_schedule_form.php?id=<?php echo $schedule['id']; ?>" class="bus-action-btn"><i class="fa fa-edit"></i> Edit</a>
                                <?php $hasBookings = !empty($booking_counts[$schedule['id']]); ?>
                                <a href="admin_schedule_delete.php?id=<?php echo $schedule['id']; ?>" class="bus-action-btn" onclick="return confirm('Are you sure you want to delete this schedule?<?php echo $hasBookings ? ' This schedule has existing bookings. Deleting it will also remove all related bookings.' : ''; ?>');"><i class="fa fa-trash"></i> Delete</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
